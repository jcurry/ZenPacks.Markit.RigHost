...
# Date:                 Sep 26th 2013
# Updated:
# Description:          Parses the rig_manager_server.cfg file in $ZENHOME/local/rig_manager_server.cfg
#                       and creates Zenoss Systems based on this file
#                       Adds devices that exist to the appropriate system(s)
#
...
logfileName = zenhome + '/log/parse_rig_manager_file.log'
...
rmfName = zenhome + '/libexec/rig_manager_server.cfg'
rmf = open(rmfName, 'r')
